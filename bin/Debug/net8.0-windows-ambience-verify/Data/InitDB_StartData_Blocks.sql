...
INSERT OR REPLACE INTO BlockAmbience (RowKey, RowData, RenderOrder, IsLocked) VALUES ('AmbienceWorldTintColor', '#808080FF', 3, 0);
...
INSERT OR REPLACE INTO BlockDockingSetups (RowKey, RowData) VALUES ('Default', '{
  ...
  "menu": [
    ...
    { "kind": "Ambience", "mode": "Toggle", "count": 0, "visible": false },
  ...
  "panels": [
    { "id": "colors", "active": "colors", "blocks": ["colors", "ambience", "notes", "dockingsetups"] },
