...
INSERT OR IGNORE INTO UITooltips (RowKey, TooltipText) VALUES ('TerrainPreloadMarginWorldUnits', 'Extra world-space margin around the camera that terrain chunk loading prebuilds ahead of view.');
...
INSERT OR IGNORE INTO UITooltips (RowKey, TooltipText) VALUES ('TerrainCenterChunk', 'Chunk coordinate currently centered under the camera.');
INSERT OR IGNORE INTO UITooltips (RowKey, TooltipText) VALUES ('TerrainVisibleChunkWindow', 'Inclusive chunk-coordinate window currently intersecting the camera view.');
