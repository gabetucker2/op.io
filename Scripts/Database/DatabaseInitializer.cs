            ...
            try
            {
                ...
                [
                    ...
                    ("Grid",
                        ...
                        "Switch"),
                    (ControlKeyMigrations.OceanBiomeDebugKey,
                        "Toggle ocean biome borders and labels.\n• ON: Shows ocean biome borders and labels.\n• OFF: Hides ocean biome borders and labels.",
                        "Switch"),
                    ...
                    ("FreezeGameInputs",
                        ...
                        "bool"),
                    ("RestartDB",
                        "Shows whether this launch is rebuilding the local database for clean deterministic startup data.",
                        "bool"),
                    ...
                    ("ShapeDrawSkippedMissingTextureCount",
                        ...
                        "int"),
                    ("RendererGraphicsLoaded",
                        "Shows whether renderer content initialization reached a safe draw-ready state.",
                        "bool"),
                    ("RendererLoadingGraphics",
                        "Shows whether LoadGraphics is currently initializing renderer resources.",
                        "bool"),
                    ("RendererCanDrawResizeFrame",
                        "Shows whether the resize paint hook is allowed to render an immediate resize frame.",
                        "bool"),
                    ("RendererStartupRevealPending",
                        "Shows whether the renderer queued the initial post-load startup window reveal.",
                        "bool"),
                    ("RendererStartupRevealRequested",
                        "Shows whether the first post-load update requested the startup window reveal and repaint.",
                        "bool"),
                    ("MainThreadStallCount",
                        "Number of update or draw calls that exceeded the main-thread stall warning threshold this run.",
                        "int"),
                    ("MainThreadLastStallStage",
                        "Whether the most recent main-thread stall was detected during Update or Draw.",
                        "string"),
                    ("MainThreadLastStallMilliseconds",
                        "Elapsed milliseconds measured for the most recent main-thread stall.",
                        "double"),
                    ("MainThreadStallThresholdMilliseconds",
                        "Elapsed milliseconds required before update or draw is logged as a main-thread stall.",
                        "double"),
                    ("MainThreadLastStallSourceSummary",
                        "Largest current-frame profiler samples captured when the most recent main-thread stall was detected.",
                        "string"),
                    ("BlockLoadActiveCount",
                        "Number of block-owned background load jobs currently running inside the global concurrency cap.",
                        "int"),
                    ("BlockLoadPendingCount",
                        "Number of block-owned background load jobs queued behind a block worker or the global concurrency cap.",
                        "int"),
                    ("BlockLoadMaxConcurrency",
                        "Maximum number of block-owned background load jobs allowed to run at once.",
                        "int"),
                    ("BlockLoadStatus",
                        "Compact status summary of block-owned background load jobs that are pending or running.",
                        "string"),
                    ("GameBlockLoading",
                        "Shows whether Game block-owned loading is active and currently pausing game simulation and non-meta gameplay inputs.",
                        "bool"),
                    ("BulletActiveCount",
                    ...
                    ("BulletBarrelLockedCount",
                        ...
                        "int"),
                    ("BulletOwnerImmuneCount",
                        "Number of active bullets currently unable to hit their firing owner because they have not physically cleared that owner's body.",
                        "int"),
                    ("BulletCollisionReadyCount",
                        "Number of active bullets that have left the barrel and can collide.",
                        "int"),
                    ("OceanBiomeDebugRequested",
                        "Shows whether the OceanBiomeDebug save switch is currently requesting ocean biome borders and labels.",
                        "bool"),
                    ("OceanBiomeDebugVisible",
                        "Shows whether ocean biome borders and labels are currently rendering. Follows the OceanBiomeDebug save switch.",
                        "bool"),
                    ("FogOfWarEnabled",
                    ...
                    ("AmbienceOceanWaterLiveColor",
                        "Current ocean water color after biome darkness has been applied.",
                        "Color"),
                    ...
                    ("AmbienceBackgroundWavesLiveColor",
                        "Current ocean wave highlight color after biome darkness has been applied.",
                        "Color"),
                    ("GameBlockOceanPlayerBiome",
                        "Current ocean biome under the runtime player, or None when the player is on terrain or unavailable.",
                        "string"),
                    ("GameBlockOceanPlayerBiomeStatus",
                        "Player ocean-biome probe detail including resolved biome, offshore distance, and water depth.",
                        "string"),
                    ("GameBlockOceanPlayerBiomeSource",
                        "Resolver source currently determining the player's ocean biome; should match the ocean-border shoreline-distance source.",
                        "string"),
                    ("GameBlockOceanCursorBiome",
                        "Current ocean biome under the cursor while it is hovering the Game block.",
                        "string"),
                    ("GameBlockOceanCursorBiomeStatus",
                        "Cursor ocean-biome probe detail including hover availability, resolved biome, offshore distance, and water depth.",
                        "string"),
                    ("GameBlockOceanCursorBiomeSource",
                        "Resolver source currently determining the cursor's ocean biome; should match the ocean-border shoreline-distance source.",
                        "string"),
                    ("GameBlockOceanCursorBiomeValid",
                        "Shows whether the cursor currently resolves to an ocean biome in the Game block.",
                        "bool"),
                    ("GameBlockOceanCursorBiomeDepth",
                        "Water depth resolved under the cursor's Game-block hover position.",
                        "float"),
                    ("GameBlockOceanCursorBiomeOffshoreDistance",
                        "Offshore distance resolved under the cursor's Game-block hover position.",
                        "float"),
                    ("GameBlockOceanBiomeTransitionBanner",
                        "Current top-center Game overlay text for an ocean-biome transition, or none when inactive.",
                        "string"),
                    ...
                    ("GameLevelTerrainConfiguration",
                        ...
                        "string"),
                    ("GameLevelOceanBiomeConfiguration",
                        "Ocean-biome configuration key requested by the active level.",
                        "string"),
                    ("GameLevelPrevious",
                    ...
                    ("GameLevelNext",
                        ...
                        "Button"),
                    ("GameLevelReload",
                        "Reload the active level from its object, farm, terrain, and ocean-biome configuration.",
                        "Button"),
                    ("GameLevelManual",
                    ...
                    ("TerrainWorldSeed",
                        ...
                        "int"),
                    ("MapBlockMode",
                        "Current Map block render mode persisted in BlockMap SQL row data.",
                        "string"),
                    ("MapBlockLastSampleCount",
                        "Number of terrain and ocean-biome samples used by the Map block during its latest texture rebuild.",
                        "int"),
                    ("MapBlockLastRebuildMilliseconds",
                        "Milliseconds spent rebuilding the Map block texture on its block-owned background worker.",
                        "double"),
                    ("MapBlockLastBounds",
                        "World bounds visualized by the Map block during its latest texture rebuild.",
                        "string"),
                    ("MapBlockLastTextureResolution",
                        "Texture resolution used by the Map block during its latest terrain and biome render.",
                        "string"),
                    ("MapBlockLastLodSummary",
                        "Latest Map block level-of-detail summary, including how many display pixels are approximated by each map texel.",
                        "string"),
                    ("MapBlockLastLodCellPixels",
                        "How many Map block display pixels are represented by each sampled map texel in the latest texture build.",
                        "int"),
                    ("MapBlockLastWorldUnitsPerTexel",
                        "Approximate world-space span represented by each Map block texture texel in the latest texture build.",
                        "float"),
                    ("MapBlockLoadStatus",
                        "Current Map block background load status, including pending or running map texture builds.",
                        "string"),
                    ("MapBlockQueuedTextureRequestId",
                        "Most recent queued Map block texture build request id.",
                        "long"),
                    ("MapBlockLastAppliedTextureRequestId",
                        "Most recent Map block texture build request id uploaded to the GPU on the main thread.",
                        "long"),
                    ("MapBlockHasDeferredTextureBuild",
                        "Whether the Map block has a newer camera or mode request waiting for the active texture build to finish instead of canceling it.",
                        "bool"),
                    ("MapBlockDeferredTextureRebuildCount",
                        "How many distinct Map block texture rebuild requests were deferred while an older texture build was already active.",
                        "int"),
                    ...
                    ("TerrainResidentChunkMemoryCap",
                        "Maximum resident terrain data chunks kept in memory before distant non-full-map chunks are pruned; full-map terrain-data preload raises this cap as needed.",
                        "int"),
                    ...
                    ("TerrainPendingCriticalChunkCount",
                        "How many camera-or-fog-visible terrain chunks are missing, queued, building, or awaiting promotion; resident terrain visuals are held stable while this is above zero.",
                        "int"),
                    ("TerrainFullMapChunkWindow",
                        ...
                        "string"),
                    ("TerrainFullMapGenerationEnabled",
                        "Whether deterministic terrain-data chunks are preloaded for the full configured terrain map so ocean biomes resolve from one authoritative terrain snapshot.",
                        "bool"),
                    ...
                    ("TerrainFullMapPendingChunkCount",
                        "How many full-map terrain-data chunks are not yet generated and retained in memory.",
                        "int"),
                    ...
                    ("TerrainFullMapSnapshotReady",
                        "Whether the generated full terrain map has been copied into the immutable mask used by ocean-biome border generation.",
                        "bool"),
                    ...
                    ("TerrainBackgroundQueuedChunkBuildCount",
                        ...
                        "int"),
                    ("TerrainNonBlockingChunkLoadRequestCount",
                        "How many runtime visible-or-near-visible chunk loads were routed to the terrain worker instead of being built on the main thread.",
                        "int"),
                    ("TerrainNonBlockingChunkLoadQueuedCount",
                        "How many terrain chunks were queued by the non-blocking visible/proximity streaming path.",
                        "int"),
                    ...
                    ("TerrainAccessRequestActive",
                        "Shows whether a deferred terrain access request is active after the immediate critical-window barrier could not finish.",
                        "bool"),
                    ("TerrainAccessRequestStatus",
                        "Current deferred terrain-access target and radius being queued after an immediate readiness miss.",
                        "string"),
                    ("TerrainMovementBlockedUntilReadyCount",
                        "How many movement attempts were held because critical terrain or ocean-border readiness could not be completed immediately.",
                        "int"),
                    ...
                    ("TerrainLandformSelectionMode",
                        ...
                        "string"),
                    ("TerrainOceanBiomeDistanceMode",
                        "Current ocean-biome distance source. Nearest-border distance keeps the shallow ocean biome wrapped around every terrain coastline.",
                        "string"),
                    ("TerrainOceanBiomeOrigin",
                        "Distance anchor used by ocean biomes. Nearest generated terrain border means every coast starts in the shallow ocean biome.",
                        "string"),
                    ("TerrainOceanBiomeOriginRadius",
                        "Effective shallow-water transition distance from the nearest terrain border.",
                        "float"),
                    ("TerrainOceanDebugWorkerStatus",
                        "Full-map ocean-biome debug border state. Borders build only after the full terrain map cache has finished.",
                        "string"),
                    ("TerrainOceanDebugFullMapReady",
                        "Whether the full-map ocean-biome border cache has finished building from the complete terrain map.",
                        "bool"),
                    ("TerrainOceanDebugFullMapSegmentCount",
                        "How many ocean-biome border segments were generated for the full map cache.",
                        "int"),
                    ("TerrainOceanDebugFullMapBuildMilliseconds",
                        "Milliseconds spent building the full-map ocean-biome border cache on the background task.",
                        "float"),
                    ("TerrainOceanDebugFullMapStatus",
                        "Detailed full-map ocean-biome border generation status and readiness summary.",
                        "string"),
                    ("TerrainOceanDebugBorderValidationCheckedSegmentCount",
                        "How many full-map ocean-biome border segments were sampled against the runtime ocean-biome resolver.",
                        "int"),
                    ("TerrainOceanDebugBorderValidationMismatchCount",
                        "How many sampled full-map ocean-biome border segments failed to match the runtime ocean-biome resolver.",
                        "int"),
                    ("TerrainOceanDebugBorderValidationCheckedIntersectionPairCount",
                        "How many full-map ocean-biome border segment pairs were checked for improper crossings.",
                        "int"),
                    ("TerrainOceanDebugBorderValidationCrossingIntersectionCount",
                        "How many improper crossings were found in the full-map ocean-biome border segments.",
                        "int"),
                    ("TerrainOceanDebugBorderValidationStatus",
                        "Pass/fail summary proving full-map ocean-biome borders match runtime ocean-biome locations and do not improperly overlap.",
                        "string"),
                    ("TerrainOceanDebugDrawStatus",
                        "Latest ocean-biome border render summary: drawn visible segments, viewport candidates, full-map segment count, and clipping mode.",
                        "string"),
                    ("TerrainOceanDebugStreamedTileSegmentCount",
                        "How many visible ocean-biome border segments came from streamed local debug tiles instead of the full-map cache.",
                        "int"),
                    ("TerrainOceanDebugMissingVisibleTileCount",
                        "How many visible ocean-biome debug tiles are still missing because their terrain chunks or border tile builds are not ready yet.",
                        "int"),
                    ("TerrainOceanDebugStreamedTileStatus",
                        "Current streamed ocean-biome debug tile coverage status for areas outside the full-map border cache.",
                        "string"),
                    ("TerrainOceanDebugVisionClipActive",
                        "Whether ocean-biome border rendering is currently clipped to fog-of-war vision.",
                        "bool"),
                    ("TerrainOceanDebugVisionClipRegionCount",
                        "How many fog-of-war vision regions are available for clipping ocean-biome borders.",
                        "int"),
                    ("TerrainOceanDebugVisionClipStatus",
                        "Current fog-of-war clipping state for ocean-biome border rendering.",
                        "string"),
                    ("TerrainOceanDebugSuppressedTinyBiomeCount",
                        "How many connected ocean-biome components were removed because no same-biome core circle met the minimum stable radius.",
                        "int"),
                    ("TerrainOceanDebugMinimumTransitionSpacingAdjustmentCount",
                        "How many ocean-biome debug cells were moved to the next shallower transition band to preserve uniform minimum spacing between biome layers.",
                        "int"),
                    ("TerrainOceanDebugMinimumStableBiomeRadius",
                        "Minimum unobstructed same-biome radius required inside an ocean-biome component before debug borders are allowed to render it.",
                        "float"),
                    ("TerrainOceanDebugTinyBiomeViolationSummary",
                        "Summary of any remaining tiny ocean-biome components that failed the minimum stable radius validation.",
                        "string"),
                    ...
                    ("TerrainOceanDebugQueuedTileCount",
                        "How many visible ocean-biome debug contour tiles are queued for background generation.",
                        "int"),
                    ("TerrainOceanDebugActiveTileBuildCount",
                        "How many ocean-biome debug contour tiles are currently building off the main thread.",
                        "int"),
                    ("TerrainOceanDebugCompletedTileQueueCount",
                        "How many generated ocean-biome debug contour tiles are waiting for bounded main-thread promotion.",
                        "int"),
                    ("TerrainOceanDebugQueuedTileBuildCount",
                        "Total ocean-biome debug contour tile builds queued during this run.",
                        "int"),
                    ("TerrainOceanBiomeMinimumTransitionVolumeDistance",
                        "SQL-backed cumulative offshore spread added per ocean-biome transition before deeper biomes begin.",
                        "float"),
                    ("TerrainOceanBiomeDistanceScale",
                        "SQL-backed multiplier applied to ocean-biome offshore thresholds before water changes to the next deeper biome.",
                        "float"),
                    ("TerrainOceanBiomeShallowDistance",
                        "Maximum offshore distance classified as the shallow ocean biome around generated landmasses.",
                        "float"),
                    ("TerrainOceanBiomeSunlitDistance",
                        "Maximum offshore distance classified as the sunlit ocean biome after the shallow band.",
                        "float"),
                    ("TerrainOceanBiomeTwilightDistance",
                        "Maximum offshore distance classified as the twilight ocean biome after the sunlit band.",
                        "float"),
                    ("TerrainOceanBiomeMidnightDistance",
                        "Maximum offshore distance classified as the midnight ocean biome before open water becomes abyss.",
                        "float"),
