    ...
    EnumDisabledOptions = excluded.EnumDisabledOptions;";
        ...
        private static Dictionary<string, ControlBindingSnapshot> BuildDefaultBindingMap()
        {
            var defaults = new[]
            {
                ...
                new ControlBindingSnapshot { SettingKey = ControlKeyMigrations.OceanZoneDebugKey, InputKey = "Z", InputType = "SaveSwitch", SwitchStartState = 1, MetaControl = false, RenderOrder = 22, LockMode = false },
