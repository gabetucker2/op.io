    ...
    EnumDisabledOptions = excluded.EnumDisabledOptions;";
        ...
        private static Dictionary<string, ControlBindingSnapshot> BuildDefaultBindingMap()
        {
            var defaults = new[]
            {
                ...
                new ControlBindingSnapshot { SettingKey = ControlKeyMigrations.YourBarKey, InputKey = "B", InputType = "Trigger", SwitchStartState = 0, MetaControl = false, RenderOrder = 22, LockMode = false },
