    ...
    EnumDisabledOptions = excluded.EnumDisabledOptions;";
        ...
        private static Dictionary<string, ControlBindingSnapshot> BuildDefaultBindingMap()
        {
            var defaults = new[]
            {
                ...
                new ControlBindingSnapshot { SettingKey = ControlKeyMigrations.GridKey, InputKey = "G", InputType = "SaveSwitch", SwitchStartState = 0, MetaControl = false, RenderOrder = 21, LockMode = false },
                new ControlBindingSnapshot { SettingKey = ControlKeyMigrations.OceanBiomeDebugKey, InputKey = "Z", InputType = "SaveSwitch", SwitchStartState = 1, MetaControl = false, RenderOrder = 22, LockMode = false },
                new ControlBindingSnapshot { SettingKey = ControlKeyMigrations.YourBarKey, InputKey = "B", InputType = "Trigger", SwitchStartState = 0, MetaControl = false, RenderOrder = 23, LockMode = false },
