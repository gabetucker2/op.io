...
{
    internal static class BlockFeedbackBarRenderer
    {
        ...
        public static Rectangle CalculateBounds(Rectangle contentBounds, Rectangle anchorBounds)
        {
            ...
            int feedbackHeight = Math.Max(0, Math.Min(Height, remainingHeight));

            return feedbackHeight > 0 && contentBounds.Width > 0
                ? new Rectangle(contentBounds.X, anchorBounds.Bottom, contentBounds.Width, feedbackHeight)
                : Rectangle.Empty;
        }
